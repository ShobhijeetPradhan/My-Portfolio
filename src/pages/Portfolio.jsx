...
// --- Custom Hook for Responsive Check (Better than window.innerWidth) ---
...
const techStacks = [
    { icon: "C.svg", language: "C" }, { icon: "C++.svg", language: "C++" }, { icon: "Csharp.svg", language: "C#" }, { icon: "Python.svg", language: "Python" }, { icon: "html.svg", language: "HTML" }, { icon: "css.svg", language: "CSS" }, { icon: "javascript.svg", language: "JavaScript" }, { icon: "tailwind.svg", language: "Tailwind CSS" }, { icon: "reactjs.svg", language: "ReactJS" }, { icon: "vite.svg", language: "Vite" }, { icon: "nodejs.svg", language: "Node JS" }, { icon: "MongoDB.svg", language: "Mongo DB" }, { icon: "vercel.svg", language: "Vercel" }, { icon: "Godot.svg", language: "Godot" },
];
