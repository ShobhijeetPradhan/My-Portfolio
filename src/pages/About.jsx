...
const Header = memo(() => (
  <div className="text-center lg:mb-8 mb-2 px-[5%]">
    ...
    >
      ...
      Leveling up ideas into interactive digital adventures.
      <Sparkles className="w-5 h-5 text-purple-400" />
    </p>
  </div>
));
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             As a Master of Computer Applications student, I specialize in building dynamic web applications and engaging games with Godot. I focus on creating intuitive, high-performance digital experiences that bring creative ideas to life. I'm driven by a love for problem-solving and am always eager to explore new technologies, with my sights set on Android development for my next adventure.
            </p>
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          Ikigai (生き甲斐) "a reason for being."
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1P_ZKDtr25EeyKfZVPSZNTZga3H1FsDla/view?usp=sharing" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
