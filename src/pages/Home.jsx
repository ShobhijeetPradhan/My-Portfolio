...
const WORDS = ["MCA Student", "Web & Game Developer"];
const TECH_STACK = ["React", "Tailwind", "Node.js", "Godot"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/ShobhijeetPradhan" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/shobhijeet-pradhan/" },
  { icon: Instagram, link: "https://www.instagram.com/_kumar.shekhar_?igsh=MXZxcm16a292MDFicg==" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Crafting responsive, high-performance, and intuitive web experiences to bring digital ideas to life.
                </p>
